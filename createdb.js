...
var createdb = function() {
  ...
  db.serialize( function() {
    db.run("create table users (name TEXT, password TEXT, email TEXT, admin INTEGER)");
    db.run("insert into users (name,password,email,admin) VALUES ('administrator', 'password', 'timgarwood@gmail.com', 1)");
